        ...
        <>
            <div className={cx('row')}>
                <div className={cx('col-md-6 col-sm-12 col-xs-12')}>
                    <div classNameName={cx('section-content section-customer-information no-mb')}>
                        ...
                        <div className={cx('fieldset')}>
                            <div classNameName="field field-required  ">
                                <div className="field-input-wrapper">
                                    <label classNameName="field-label" for="billing_address_full_name">
                                        Họ và tên
                                    </label>
                                    <input
