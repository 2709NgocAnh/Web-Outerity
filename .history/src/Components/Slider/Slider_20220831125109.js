            ...
            <div id="carouselExampleControls" className={cx('carousel slide')} data-bs-ride="carousel">
                <div className={cx('carousel-inner')}>
                    <div className={cx('carousel-item active')}>
                        <img
                            src="https://yt3.ggpht.com/a/AATXAJwQqrbD1szIUl-F3d7o5SKjJwJ5pDGHt-_YsA=s900-c-k-c0xffffffff-no-rj-mo"
                    ...
                    <div className={cx('carousel-item')}>
                        <img
                            src="https://yt3.ggpht.com/a/AATXAJzW-zGSV6jOnrVu-jjFaE0laVD6iJI4x7EAUM7hYw=s900-c-k-c0xffffffff-no-rj-mo"
                            className={cx('d-block w-100')}
                            alt="..."
                        />
                    </div>
