                                                ...
                                                <div className="field field-required  ">
                                                    <div className="field-input-wrapper">
                                                        ...
                                                        <input
                                                            ...
                                                            required
                                                            onChange={(e) => setName(e.target.valuevalue)}
                                                            value={name}
                                                        />
                                                        {value === '' ? <span>'Vui lòng nhập họ và tên'</span> : ''}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="field field-required field-third  ">
                                                    <div class="field-input-wrapper">
                                                        ...
                                                        <input
                                                            ...
                                                            value={phone}
                                                        />
                                                        {value === '' ? <span>'Vui lòng nhập số điện thoại'</span> : ''}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="fieldset">
                                        <div class="field  ">
                                            <div class="field-input-btn-wrapper">
                                                ...
                                                >
                                                    <span class="field field-required field-third">Sử dụng</span>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <tbody>
                                        <tr class="total-line total-line-subtotal">
                                            ...
                                            <td class="total-line-price">
                                                <span class="order-summary-emphasis">{total}.000 VND</span>
                                            </td>
                                        </tr>
                                    ...
                                    <tfoot class="total-line-table-footer">
                                        <tr class="total-line">
                                            ...
                                            <td class="total-line-name payment-due">
                                                ...
                                                <span class="checkout_version" data_checkout_version="8"></span>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
