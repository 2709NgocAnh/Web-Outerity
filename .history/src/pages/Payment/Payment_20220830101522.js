...
import className=s from 'className=s/bind';
...
export default function Payment() {
    TabTitle('Payment');
    const cx = className=s.bind(styles);
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <input
                                                                        ...
                                                                        className='input-radio'                                                                       name="payment_method_id"
                                                                        type="radio"
                                                                        value="1002766550"
                                                                        checked=""
                                                                    />
                                                                ...
                                                                <div className='radio-content-input'>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <span
                                                                            className='quick-tagline hidden'
                                                                        ></span>
                                    ...
                                    <div className='fieldset'>
                                        <div className='field  '>
                                            <div className='field-input-btn-wrapper'>
                                                ...
                                                >
                                                    <span className='field field-required field-third'>
                                                        Sử dụng
                                                    </span>
                                                </button>
                                            </div>
