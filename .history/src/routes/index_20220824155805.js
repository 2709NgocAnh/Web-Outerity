...
import ForgetPassword from '~/pages/Register/FormRegister';
...
const publicRoutes = [
    ...
    { path: config.routes.forgetpassword, component:  },
    ...
    //admin
    { path: config.routes.home, component: Home, layout: DefaultLayoutAdmin },
];
const privateRoutes = [];
