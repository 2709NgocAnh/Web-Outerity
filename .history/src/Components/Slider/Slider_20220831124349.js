            ...
            <div id="carouselExampleControls" className={cx('carousel slide')} data-bs-ride="carousel">
                <div className={cx('carousel-inner')}>
                    <div className={cx('carousel-item active')}>
                        <img
                            src="https://th.bing.com/th/id/R.e0429f80edd816fc899c2cf8a3683842?rik=mG0Cn93o5G2hmA&pid=ImgRaw&r=0"
                            className={cx('d-block w-100')}
                            alt="..."
                        />
                    </div>
                    <div className={cx('carousel-item')}>
                        <img src="~/asset/image/slider2.jpeg" className={cx('d-block w-100')} alt="..." />
                    </div>
                    <div className={cx('carousel-item')}>
