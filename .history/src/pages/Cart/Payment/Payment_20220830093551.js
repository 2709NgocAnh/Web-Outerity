                        ...
                        <div className={cx("main-content")}>
                            <div className={cx("step")}>
                                            ...
                                            <div className ={cx("fieldset")}>
                                                ...
                                                >
                                                    <div
                                                        ...
                                                        className ={cx("order-checkout__loading radio-wrapper content-box-row content-box-row-padding content-box-row-secondary ")}
                                                        for="customer_pick_at_location_false"
                                                    >
                                                        <input name="utf8" type="hidden" value="✓" />
                                                        <div className ={cx("field-input-wrapper")}>
                                                            <label className ={cx("field-label" )}for="billing_address_address1">
                                                                Địa chỉ
                                                            </label>
                                                            <input
                                                                placeholder="Địa chỉ"
                                                    ...
                                                    <div className ={cx("field field-show-floating-label field-required field-third ")}>
                                                        <div className ={cx("field-input-wrapper field-input-wrapper-select")}>
                                                            <label className ={cx("field-label" )}for="customer_shipping_province">
                                                                {' '}
                                                                Tỉnh / thành{' '}
                                                            </label>
                                                            <select
                                                    ...
                                                    <div className ={cx("field field-show-floating-label field-required field-third ")}>
                                                        <div className ={cx("field-input-wrapper field-input-wrapper-select")}>
                                                            <label className ={cx("field-label" )}for="customer_shipping_district">
                                                                Quận / huyện
                                                            </label>
                                                            <select
                                                                className ={cx("field-input")}
                                                    ...
                                                    <div className ={cx("field field-show-floating-label field-required  field-third  ")}>
                                                        <div className ={cx("field-input-wrapper field-input-wrapper-select")}>
                                                            <label className ={cx("field-label" )}for="customer_shipping_ward">
                                                                Phường / xã
                                                            </label>
                                                            <select
                                                                className ={cx("field-input")}
                                                            ...
                                                            >
                                                                ...
                                                                <div className ={cx("radio-content-input")}>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <span className ={cx("quick-tagline hidden")}></span>
                                ...
                                <div className ={cx("step-footer")}>
                                    ...
                                    <NavLink className={cx((nav) => { active: nav.isActive })} to={config.routes.cart}>
                                        Giỏ hàng
                                    </NavLink>
                                </div>
                            </div>
                                    ...
                                    <div className ={cx("fieldset")}>
                                        <div className ={cx("field  ")}>
                                            <div className ={cx("field-input-btn-wrapper")}>
                                                ...
                                                >
                                                    <span className ={cx("field field-required field-third")}>Sử dụng</span>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <tfoot className ={cx("total-line-table-footer")}>
                                        <tr className ={cx("total-line")}>
                                            ...
                                            <td className ={cx("total-line-name payment-due")}>
                                                ...
                                                <span className ={cx("checkout_version" data_checkout_version="8")}></span>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
