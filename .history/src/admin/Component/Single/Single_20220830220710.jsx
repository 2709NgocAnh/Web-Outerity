...
import { userColumns, userRows } from '~/admin/pages/Users/datatablesource';
// import Chart from '../../components/chart/Chart';
import List from '../table/Table';
function Single() {
    const cx = classNames.bind(styles);
    const details = userColumns.filter((product, index) => {
                ...
                <div className={cx('top')}>
                    <div className={cx('left')}>
                        ...
                        {collects.map((collect) => {
                            return (
                                <div className={cx('item')} key={collect._id}>
                                    <img src={collect.img} alt="" className={cx('itemImg')} />

                                    <div className={cx('details')}>
                                        <div className={cx('detailItem')}>
                                            <span className={cx('itemKey')}></span>
