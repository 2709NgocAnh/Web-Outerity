            ...
            <div className={cx('row')}>
                <div class={cx('col-md-6 col-sm-12 col-xs-12')}>
                    <div class={cx('section-content section-customer-information no-mb')}>
                        ...
                        <div class={cx('fieldset')}>
                            <div class={cx('field field-required  ')}>
                                <div class={cx('field-input-wrapper')}>
                                    <label class={cx('field-label')} for="billing_address_full_name">
                                        Họ và tên
                                    </label>
                                    <input
                            ...
                            <div class={cx('field  field-two-thirds  ')}>
                                <div class={cx('field-input-wrapper')}>
                                    <label class={cx('field-label')} for="checkout_user_email">
                                        Email
                                    </label>
                                    <input
                                        autocomplete="false"
                            ...
                            <div class="field field-required field-third  ">
                                <div class="field-input-wrapper">
                                    <label class={cx('field-label')} for="billing_address_phone">
                                        Số điện thoại
                                    </label>
                                    <input
                                        autocomplete="false"
																							...
																							<div class="field-input-wrapper field-input-wrapper-select">
																								...
																								<select class="field-input" id="customer_shipping_district" name="customer_shipping_district">
																									<option data-code="null" value="null">Chọn quận / huyện</option>
																											...
																											<option data-code="HC483" value="483" selected="">Huyện Củ Chi</option>
																								...
																								<div class="field-input-wrapper field-input-wrapper-select">
																									...
																									<select class="field-input" id="customer_shipping_ward" name="customer_shipping_ward">
																										<option data-code="null" value="null">Chọn phường / xã</option>
																												...
																												<option data-code="27496" value="27496">Thị trấn Củ Chi</option>
																											
																												<option data-code="27508" value="27508">Xã An Nhơn Tây</option>
																											
																												<option data-code="27502" value="27502" selected="">Xã An Phú</option>
																											
																												<option data-code="27550" value="27550">Xã Bình Mỹ</option>
																											
																												<option data-code="27544" value="27544">Xã Hòa Phú</option>
																											
																												<option data-code="27511" value="27511">Xã Nhuận Đức</option>
																											
																												<option data-code="27517" value="27517">Xã Phú Hòa Đông</option>
																											
																												<option data-code="27499" value="27499">Xã Phú Mỹ Hưng</option>
																											
																												<option data-code="27529" value="27529">Xã Phước Hiệp</option>
																											
																												<option data-code="27526" value="27526">Xã Phước Thạnh</option>
																											
																												<option data-code="27535" value="27535">Xã Phước Vĩnh An</option>
																											
																												<option data-code="27514" value="27514">Xã Phạm Văn Cội</option>
																											
																												<option data-code="27538" value="27538">Xã Thái Mỹ</option>
																											
																												<option data-code="27523" value="27523">Xã Trung An</option>
																											
																												<option data-code="27520" value="27520">Xã Trung Lập Hạ</option>
																											
																												<option data-code="27505" value="27505">Xã Trung Lập Thượng</option>
																											
																												<option data-code="27532" value="27532">Xã Tân An Hội</option>
																											
																												<option data-code="27553" value="27553">Xã Tân Phú Trung</option>
																											
																												<option data-code="27556" value="27556">Xã Tân Thông Hội</option>
																											
																												<option data-code="27541" value="27541">Xã Tân Thạnh Tây</option>
																											
																												<option data-code="27547" value="27547">Xã Tân Thạnh Đông</option>
