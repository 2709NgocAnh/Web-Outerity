            ...
            <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src="~/asset/image/slider1.jpeg" className="d-block w-100" alt="..." />
                    </div>
                    <div className="carousel-item">
                        <img src="~/asset/image/slider2.jpeg" className="d-block w-100" alt="..." />
                    </div>
                    <div className="carousel-item">
                        <img src="~/asset/image/slider3.jpeg" className="d-block w-100" alt="..." />
                    </div>
                </div>
            </div>
